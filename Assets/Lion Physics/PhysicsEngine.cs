...
namespace Lion.Physics
{
    ...
    {
        public static bool DetectCollision(Circle circle1, Circle circle2, out float distance)
        {
            distance = Vector2.Distance(circle1.transform.position, circle2.transform.position);
            return distance < (circle1.Radius + circle2.Radius);
        }

        public static void ResolveCollision(Circle circle1, Circle circle2, float distance)
        {
